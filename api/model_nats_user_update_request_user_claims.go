...
// checks if the NatsUserUpdateRequestUserClaims type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NatsUserUpdateRequestUserClaims{}

// NatsUserUpdateRequestUserClaims struct for NatsUserUpdateRequestUserClaims
type NatsUserUpdateRequestUserClaims struct {
...
func NewNatsUserUpdateRequestUserClaims() *NatsUserUpdateRequestUserClaims {
	this := NatsUserUpdateRequestUserClaims{}
	return &this
}
...
func (o *NatsUserUpdateRequestUserClaims) SetRespNil() {
	o.Resp.Set(nil)
}
...
func (o NatsUserUpdateRequestUserClaims) ToMap() (map[string]interface{}, error) {
...
type NullableNatsUserUpdateRequestUserClaims struct {
	value *NatsUserUpdateRequestUserClaims
	isSet bool
}

func (v NullableNatsUserUpdateRequestUserClaims) Get() *NatsUserUpdateRequestUserClaims {
	return v.value
}

func (v *NullableNatsUserUpdateRequestUserClaims) Set(val *NatsUserUpdateRequestUserClaims) {
	v.value = val
	v.isSet = true
}

func (v NullableNatsUserUpdateRequestUserClaims) IsSet() bool {
	return v.isSet
}

func (v *NullableNatsUserUpdateRequestUserClaims) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNatsUserUpdateRequestUserClaims(val *NatsUserUpdateRequestUserClaims) *NullableNatsUserUpdateRequestUserClaims {
	return &NullableNatsUserUpdateRequestUserClaims{value: val, isSet: true}
}

func (v NullableNatsUserUpdateRequestUserClaims) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNatsUserUpdateRequestUserClaims) UnmarshalJSON(src []byte) error {
	v.isSet = true
