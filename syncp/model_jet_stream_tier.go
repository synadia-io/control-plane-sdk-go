...
type _JetStreamTier JetStreamTier
...
func (o *JetStreamTier) UnmarshalJSON(bytes []byte) (err error) {
	...
	varJetStreamTier := _JetStreamTier{}

	err = json.Unmarshal(bytes, &varJetStreamTier)

	if err != nil {
		return err
	}

	*o = JetStreamTier(varJetStreamTier)
