...
type _JSKVBucketListResponse JSKVBucketListResponse
...
func (o *JSKVBucketListResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varJSKVBucketListResponse := _JSKVBucketListResponse{}

	err = json.Unmarshal(bytes, &varJSKVBucketListResponse)

	if err != nil {
		return err
	}

	*o = JSKVBucketListResponse(varJSKVBucketListResponse)
