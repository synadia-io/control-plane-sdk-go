...
type _SigningKeyViewResponse SigningKeyViewResponse
...
func (o *SigningKeyViewResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSigningKeyViewResponse := _SigningKeyViewResponse{}

	err = json.Unmarshal(bytes, &varSigningKeyViewResponse)

	if err != nil {
		return err
	}

	*o = SigningKeyViewResponse(varSigningKeyViewResponse)
