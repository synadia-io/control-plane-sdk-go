...
type _AppUserCreateRequest AppUserCreateRequest
...
func (o *AppUserCreateRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAppUserCreateRequest := _AppUserCreateRequest{}

	err = json.Unmarshal(bytes, &varAppUserCreateRequest)

	if err != nil {
		return err
	}

	*o = AppUserCreateRequest(varAppUserCreateRequest)
