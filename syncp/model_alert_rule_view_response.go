...
type _AlertRuleViewResponse AlertRuleViewResponse
...
func (o *AlertRuleViewResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAlertRuleViewResponse := _AlertRuleViewResponse{}

	err = json.Unmarshal(bytes, &varAlertRuleViewResponse)

	if err != nil {
		return err
	}

	*o = AlertRuleViewResponse(varAlertRuleViewResponse)
