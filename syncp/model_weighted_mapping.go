...
type _WeightedMapping WeightedMapping
...
func (o *WeightedMapping) UnmarshalJSON(bytes []byte) (err error) {
	...
	varWeightedMapping := _WeightedMapping{}

	err = json.Unmarshal(bytes, &varWeightedMapping)

	if err != nil {
		return err
	}

	*o = WeightedMapping(varWeightedMapping)
