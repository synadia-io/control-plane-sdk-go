...
type _SigningKeyGroupViewResponse SigningKeyGroupViewResponse
...
func (o *SigningKeyGroupViewResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSigningKeyGroupViewResponse := _SigningKeyGroupViewResponse{}

	err = json.Unmarshal(bytes, &varSigningKeyGroupViewResponse)

	if err != nil {
		return err
	}

	*o = SigningKeyGroupViewResponse(varSigningKeyGroupViewResponse)
