...
type _ConsumerConfig ConsumerConfig
...
func (o *ConsumerConfig) UnmarshalJSON(bytes []byte) (err error) {
	...
	varConsumerConfig := _ConsumerConfig{}

	err = json.Unmarshal(bytes, &varConsumerConfig)

	if err != nil {
		return err
	}

	*o = ConsumerConfig(varConsumerConfig)
