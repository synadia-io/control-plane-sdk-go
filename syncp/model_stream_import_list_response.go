...
type _StreamImportListResponse StreamImportListResponse
...
func (o *StreamImportListResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varStreamImportListResponse := _StreamImportListResponse{}

	err = json.Unmarshal(bytes, &varStreamImportListResponse)

	if err != nil {
		return err
	}

	*o = StreamImportListResponse(varStreamImportListResponse)
