...
func (o *GatewayStat) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGatewayStat := _GatewayStat{}

	err = json.Unmarshal(bytes, &varGatewayStat)

	if err != nil {
		return err
	}

	*o = GatewayStat(varGatewayStat)
