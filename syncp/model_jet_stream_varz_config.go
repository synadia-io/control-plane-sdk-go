...
type _JetStreamVarzConfig JetStreamVarzConfig
...
func (o *JetStreamVarzConfig) UnmarshalJSON(bytes []byte) (err error) {
	...
	varJetStreamVarzConfig := _JetStreamVarzConfig{}

	err = json.Unmarshal(bytes, &varJetStreamVarzConfig)

	if err != nil {
		return err
	}

	*o = JetStreamVarzConfig(varJetStreamVarzConfig)
