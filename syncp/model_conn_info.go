...
func (o *ConnInfo) UnmarshalJSON(bytes []byte) (err error) {
	...
	varConnInfo := _ConnInfo{}

	err = json.Unmarshal(bytes, &varConnInfo)

	if err != nil {
		return err
	}

	*o = ConnInfo(varConnInfo)
