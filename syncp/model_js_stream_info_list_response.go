...
type _JSStreamInfoListResponse JSStreamInfoListResponse
...
func (o *JSStreamInfoListResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varJSStreamInfoListResponse := _JSStreamInfoListResponse{}

	err = json.Unmarshal(bytes, &varJSStreamInfoListResponse)

	if err != nil {
		return err
	}

	*o = JSStreamInfoListResponse(varJSStreamInfoListResponse)
